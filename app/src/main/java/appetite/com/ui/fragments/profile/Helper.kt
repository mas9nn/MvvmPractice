...
class Helper(private val context: Context, private val swipeControllerActions: actions) :
    ...
    override fun getMovementFlags(
        ...
        imageDrawable = context.getDrawable(R.drawable.ic_back)!!
        shareRound = context.getDrawable(R.drawable.ic_back)!!
